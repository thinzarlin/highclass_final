...
@section('content')
    <div class="pb-5 text-xl text-gray-700">
        ...
        <div class="flex justify-start mt-1">
            @php
                $route =
                    $from == 'main' ? route('home-car-mains.edit', $homeCarMain->id) : route('home-car-main-cbs.index');
            @endphp
        ...
        <div class="w-full">
            <form method="POST" action="{{ route('home-car-main-cbs.store') }}" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-6 gap-4">
                    <div class="mb-2">
                        ...
                        <input type="hidden" name="main_id" value="{{ old('main_id', $homeCarMain->id) }}">
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('out_date', date('d-m-Y', strtotime($homeCarMain->out_date))) }}" required>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('in_date', date('d-m-Y', strtotime($homeCarMain->in_date))) }}" required>
                    ...
                    <div class="grid grid-cols-9 gap-4">
                        <div class="hidden mb-2">
                            ...
                            <input
                                ...
                                value="{{ old('max_line_no', count($sampleCb->details) + 1) }}">
                        </div>
                    ...
                    <div class="mb-4">
                        <div class="relative overflow-x-auto">
                            <table
                                ...
                                <tbody>
                                    @if ($sampleCb && $sampleCb->details)
                                        @foreach ($sampleCb->details as $detail)
                ...
                <div class="flex justify-end gap-5">
                    <div class="mb-2">
                        <input
                            ...
                            id="net_amount_debit_label" name="net_amount_debit_label" type="text"
                            placeholder="Net Amount" value="{{ old('net_amount_debit_label', number_format($sampleCb?->net_amount_debit ?? 0)) }}" readonly>
                    </div>

                    <div class="mb-2">
                        <input
                            class="text-right w-32 shadow py-1 px-2.5 leading-[2] bg-white border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block"
                            id="net_amount_credit_label" name="net_amount_credit_label" type="text"
                            placeholder="Net Amount" value="{{ old('net_amount_credit_label', number_format($sampleCb?->net_amount_credit ?? 0)) }}" readonly>
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-5">
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('total_1_label', number_format($sampleCb?->total ?? 0)) }}" readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('total_2_label', number_format($sampleCb?->total ?? 0)) }}" readonly>
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-5">
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('total_income_label', number_format($sampleCb?->total_income ?? 0)) }}" readonly>
                    </div>

                    <div class="mb-2">
                        <input
                            class="text-right w-32 shadow py-1 px-2.5 leading-[2] bg-white border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block"
                            id="total_expense_label" name="total_expense_label" type="text"
                            placeholder="Credit Total" value="{{ old('total_expense_label', number_format($sampleCb?->total_expense ?? 0)) }}" readonly>
                    </div>
                </div>
                ...
                <div class="justify-end gap-5 hidden">
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('net_amount_debit', $sampleCb?->net_amount_debit ?? 0) }}" readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('net_amount_credit', $sampleCb?->net_amount_credit ?? 0) }}" readonly>
                    </div>
                </div>
                ...
                <div class="justify-end gap-5 hidden">
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('total_1', $sampleCb?->total_1 ?? 0) }}" readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('total_2', $sampleCb?->total_2 ?? 0) }}" readonly>
                    </div>
                </div>
                ...
                <div class="justify-end gap-5 hidden">
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('total_income', $sampleCb?->total_income ?? 0) }}" readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('total_expense', $sampleCb?->total_expense ?? 0) }}" readonly>
                    </div>
                </div>
