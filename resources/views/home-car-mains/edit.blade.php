...
@section('content')
    <div class="pb-5 text-xl text-gray-700">
        ...
        <div class="w-full">
            <form method="POST" action="{{ route('home-car-mains.update', $homeCarMain->id) }}" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-6 gap-4">
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('ref_no', $homeCarMain->ref_no) }}" readonly required>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('out_date', $homeCarMain->out_date) }}" required>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('in_date', $homeCarMain->in_date) }}" required>
                        ...
                        <select
                            ...
                            @foreach ($daily_cars as $key => $daily_car)
                                <option value="{{ $daily_car->id }}"
                                    {{ old('daily_car_list_id', $homeCarMain->daily_car_list_id) == $daily_car->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('tour', $homeCarMain->tour->short_name) }}" readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('car_no', $homeCarMain->car->car_no) }}" readonly>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-4 gap-4">
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('driver_1', $homeCarMain->daily_car_list->driver_1?->name) }}" readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('driver_2', $homeCarMain->daily_car_list->driver_2?->name) }}" readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('spare', $homeCarMain->daily_car_list->spare?->name) }}" readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('crew', $homeCarMain->daily_car_list->crew?->name) }}" readonly>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-4 gap-4">
                    ...
                    <div class="col-span-2 mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('remark', $homeCarMain->remark) }}">
                    </div>
                    ...
                    <div id="ticketSection">
                        <div class="grid grid-cols-9 gap-4">
                            <div class="hidden mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('max_ticket_line_no', count($homeCarMain->tickets) + 1) }}">
                            </div>
                        ...
                        <div class="grid grid-cols-5 gap-5 mb-4">
                            <div class="relative overflow-x-auto col-span-4">
                                <table
                                    ...
                                    <tbody>
                                        @php
                                            $total_ticket_cash = 0;
                                            $total_ticket_lan_tg = 0;
                                            $total_ticket_ygn_tg = 0;
                                            $total_ticket_next_car = 0;
                                        @endphp
                                        @if ($homeCarMain->tickets)
                                            @foreach ($homeCarMain->tickets as $ticket)
                                                @php
                                                    switch ($ticket['type']) {
                                                        case 'cash':
                                                            $total_ticket_cash += $ticket['amount'];
                                                            break;
                                                        case 'lan_tg':
                                                            $total_ticket_lan_tg += $ticket['amount'];
                                                            break;
                                                        case 'ygn_tg':
                                                            $total_ticket_ygn_tg += $ticket['amount'];
                                                            break;
                                                        case 'next_car':
                                                            $total_ticket_next_car += $ticket['amount'];
                                                            break;
                                                    }
                                                @endphp
                                                <tr class="bg-slate-50 text-gray-800 text-sm border-b border-gray-200">
                                                    ...
                                                    <td class="px-3 py-2 text-right border"><input type="hidden"
                                                            value="{{ $ticket['line_no'] }}"
                                                            name='ticket_line_no[]'>{{ $ticket['line_no'] }}</td>
                                                    <td class="px-3 py-2 border"><input type="hidden"
                                                            value="{{ $ticket['type'] }}" name='ticket_type[]'><input
                                                            type="hidden"
                                                            value="{{ config('enums.home_car_main_ticket_types.' . $ticket['type']) }}"
                                                            name='ticket_type_name[]'>{{ config('enums.home_car_main_ticket_types.' . $ticket['type']) }}
                                                    </td>
                                                    <td class="px-3 py-2 border"><input type="hidden"
                                                            value="{{ $ticket['people'] }}"
                                                            name='ticket_people[]'>{{ $ticket['people'] }}</td>
                                                    <td class="px-3 py-2 text-right border"><input type="hidden"
                                                            value="{{ $ticket['amount'] }}"
                                                            name='ticket_amount[]'>{{ $ticket['amount'] }}</td>
                                                    <td class="px-3 py-2 border"><input type="hidden"
                                                            value="{{ $ticket['remark'] }}"
                                                            name='ticket_remark[]'>{{ $ticket['remark'] }}</td>
                                                </tr>
                                            @endforeach
                                        @endif
                                    </tbody>
                            ...
                            <div class="grid grid-cols-2 text-sm gap-y-3 text-gray-800">
                                <p>လက်ငင်း</p>
                                <p>: <span id="total_ticket_cash_label">{{ $total_ticket_cash }}</span></p>
                                <p>လမ်းတောင်း</p>
                                <p>: <span id="total_ticket_lan_tg_label">{{ $total_ticket_lan_tg }}</span></p>
                                <p>ရန်ကုန်</p>
                                <p>: <span id="total_ticket_ygn_tg_label">{{ $total_ticket_ygn_tg }}</span></p>
                                <p>နောက်ကားနဲ့ပါ</p>
                                <p>: <span id="total_ticket_next_car_label">{{ $total_ticket_next_car }}</span></p>
                            </div>
                        </div>
                        ...
                        <div class="justify-end gap-5 hidden">
                            <div class="mt-2 ">
                                ...
                                <input
                                    ...
                                    placeholder="လက်ငင်း Total"
                                    value="{{ old('total_ticket_cash', $total_ticket_cash) }}" readonly>
                            </div>
                            ...
                            <div class="mt-2">
                                ...
                                <input
                                    ...
                                    placeholder="လမ်းတောင်း Total"
                                    value="{{ old('total_ticket_lan_tg', $total_ticket_lan_tg) }}" readonly>
                            </div>
                            ...
                            <div class="mt-2">
                                ...
                                <input
                                    ...
                                    placeholder="ရန်ကုန် Total"
                                    value="{{ old('total_ticket_ygn_tg', $total_ticket_ygn_tg) }}" readonly>
                            </div>
                            ...
                            <div class="mt-2">
                                ...
                                <input
                                    ...
                                    placeholder="နောက်ကားနဲ့ပါ Total"
                                    value="{{ old('total_ticket_next_car', $total_ticket_next_car) }}" readonly>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <div class="flex justify-end gap-5">
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('total_people', $homeCarMain->total_people) }}" readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('total_ticket', $homeCarMain->total_ticket) }}" readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('insurance', $homeCarMain->insurance) }}" oninput="calTicketIncome()">
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('ticket_income', $homeCarMain->ticket_income) }}" readonly>
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-8 gap-5">
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('total_cargo', $homeCarMain->total_cargo) }}"
                                    oninput="calCashCargo('total')">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('cash_cargo', $homeCarMain->cash_cargo) }}"
                                    oninput="calCashCargo('cash')">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('credit_cargo', $homeCarMain->credit_cargo) }}"
                                    oninput="calCashCargo('credit')">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('cargo_bd', $homeCarMain->cargo_bd) }}" oninput="calCargoIncome()">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('lu_par_cargo', $homeCarMain->lu_par_cargo) }}"
                                    oninput="calCargoIncome()">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-7 gap-4">
                            <div class="hidden mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('max_out_cargo_line_no', count($homeCarMain->out_cargos) + 1) }}">
                            </div>
                        ...
                        <div class="grid grid-cols-5 gap-5 mb-4">
                            <div class="relative overflow-x-auto col-span-4">
                                <table
                                    ...
                                    <tbody>
                                        @php
                                            $total_out_credit_cargo = 0;
                                            $total_out_cargo_deli = 0;
                                            $total_out_credit_khauk_to = 0;
                                            $total_out_site_shin = 0;
                                            $total_out_cargo_percent = 0;
                                        @endphp
                                        @if ($homeCarMain->out_cargos)
                                            @foreach ($homeCarMain->out_cargos as $out_cargo)
                                                @php
                                                    $total_out_credit_cargo += $out_cargo['credit_cargo'] ?? 0;
                                                    $total_out_cargo_deli += $out_cargo['deli'] ?? 0;
                                                    $total_out_credit_khauk_to += $out_cargo['credit_khauk_to'] ?? 0;
                                                    $total_out_site_shin += $out_cargo['site_shin'] ?? 0;
                                                    $total_out_cargo_percent += $out_cargo['percent'] ?? 0;
                                                @endphp
                                                <tr class="bg-slate-50 text-gray-800 text-sm border-b border-gray-200">
                                                    <td class="px-3 py-2 border">
                                                        <button type="button" class="ticketDeleteBtn">
                                                    ...
                                                    <td class="px-3 py-2 text-right border"><input type="hidden"
                                                            value="{{ $out_cargo['line_no'] }}"
                                                            name='out_cargo_line_no[]'>{{ $out_cargo['line_no'] }}</td>
                                                    <td class="px-3 py-2 border"><input type="hidden"
                                                            value="{{ $out_cargo['city_id'] }}"
                                                            name='out_cargo_city_id[]'><input type="hidden"
                                                            value="{{ $cities->firstWhere('id', $out_cargo['city_id'])?->en_name }}"
                                                            name='out_cargo_city_name[]'>{{ $cities->firstWhere('id', $out_cargo['city_id'])?->en_name }}
                                                    </td>
                                                    <td class="px-3 py-2 text-right border"><input type="hidden"
                                                            value="{{ $out_cargo['credit_cargo'] }}"
                                                            name='out_credit_cargo[]'>{{ $out_cargo['credit_cargo'] }}
                                                    </td>
                                                    <td class="px-3 py-2 text-right border"><input type="hidden"
                                                            value="{{ $out_cargo['deli'] }}"
                                                            name='out_cargo_deli[]'>{{ $out_cargo['deli'] }}</td>
                                                    <td class="px-3 py-2 text-right border"><input type="hidden"
                                                            value="{{ $out_cargo['credit_khauk_to'] }}"
                                                            name='out_credit_khauk_to[]'>{{ $out_cargo['credit_khauk_to'] }}
                                                    </td>
                                                    <td class="px-3 py-2 text-right border"><input type="hidden"
                                                            value="{{ $out_cargo['site_shin'] }}"
                                                            name='out_site_shin[]'>{{ $out_cargo['site_shin'] }}</td>
                                                    <td class="px-3 py-2 text-right border"><input type="hidden"
                                                            value="{{ $out_cargo['percent'] }}"
                                                            name='out_cargo_percent[]'>{{ $out_cargo['percent'] }}
                                                    </td>
                                                    <td class="px-3 py-2 text-center border"><input type="hidden"
                                                            value="{{ $out_cargo['paid'] }}"
                                                            name='out_cargo_paid[]'>{{ $out_cargo['paid'] == true ? 'Yes' : 'No' }}
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @endif
                            ...
                            <div class="grid grid-cols-2 text-sm gap-y-3 text-gray-800">
                                ...
                                <p>: <span id="total_out_credit_cargo_label">{{ $total_out_credit_cargo }}</span></p>
                                <p>အရောက်ပို့လက်ငင်း</p>
                                <p>: <span id="total_out_cargo_deli_label">{{ $total_out_cargo_deli }}</span></p>
                                <p>ခေါက်တိုကြွေး</p>
                                <p>: <span id="total_out_credit_khauk_to_label">{{ $total_out_credit_khauk_to }}</span>
                                </p>
                                <p>စိုက်ရှင်းငွေ</p>
                                <p>: <span id="total_out_site_shin_label">{{ $total_out_site_shin }}</span></p>
                                <p>အသွား ဂိတ် %</p>
                                <p>: <span id="total_out_cargo_percent_label">{{ $total_out_cargo_percent }}</span></p>
                            </div>
                        </div>
                        ...
                        <div class="justify-end gap-5 hidden">
                            <div class="mt-2 ">
                                ...
                                <input
                                    ...
                                    placeholder="အသားတင်ကုန်ကြွေး Total"
                                    value="{{ old('total_out_credit_cargo', $total_out_credit_cargo) }}" readonly>
                            </div>
                            ...
                            <div class="mt-2">
                                ...
                                <input
                                    ...
                                    placeholder="အရောက်ပို့လက်ငင်း Total"
                                    value="{{ old('total_out_cargo_deli', $total_out_cargo_deli) }}" readonly>
                            </div>
                            ...
                            <div class="mt-2">
                                ...
                                <input
                                    ...
                                    placeholder="ခေါက်တိုကြွေး Total"
                                    value="{{ old('total_out_credit_khauk_to', $total_out_credit_khauk_to) }}" readonly>
                            </div>
                            ...
                            <div class="mt-2">
                                ...
                                <input
                                    ...
                                    placeholder="စိုက်ရှင်းငွေ Total"
                                    value="{{ old('total_out_site_shin', $total_out_site_shin) }}" readonly>
                            </div>
                            ...
                            <div class="mt-2">
                                ...
                                <input
                                    ...
                                    placeholder="အသွား ဂိတ် % Total"
                                    value="{{ old('total_out_cargo_percent', $total_out_cargo_percent) }}" readonly>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <div class="flex justify-end gap-5">
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('cargo_income', $homeCarMain->cargo_income) }}" readonly>
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-5">
                    <div class="mb-2">
                        ...
                        <input readonly
                            ...
                            value="{{ old('grand_total', $homeCarMain->grand_total) }}">
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-5">
                    <div class="mb-2">
                        ...
                        <input readonly
                            ...
                            value="{{ old('gate_percent', $homeCarMain->gate_percent) }}">
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input readonly
                            ...
                            value="{{ old('gate_commission', $homeCarMain->gate_commission) }}">
                    </div>
                </div>
                        ...
                        <div class="grid lg:grid-cols-8 md:grid-cols-4 gap-5">
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('water_small_qty', $homeCarMain->water_small_qty) }}"
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('water_small_amt', $homeCarMain->water_small_amt) }}"
                                    oninput="calExpenseTotal()">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('water_large_qty', $homeCarMain->water_large_qty) }}"
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('water_large_amt', $homeCarMain->water_large_amt) }}"
                                    oninput="calExpenseTotal()">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('drink_qty', $homeCarMain->drink_qty) }}"
                                    oninput="calExpenseAmt('drink', this.value)">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('drink_amt', $homeCarMain->drink_amt) }}" oninput="calExpenseTotal()">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('snack_qty', $homeCarMain->snack_qty) }}"
                                    oninput="calExpenseAmt('snack', this.value)">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('snack_amt', $homeCarMain->snack_amt) }}" oninput="calExpenseTotal()">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    placeholder="မုန့် (အထူး)"
                                    value="{{ old('snack_special_qty', $homeCarMain->snack_special_qty) }}"
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('snack_special_amt', $homeCarMain->snack_special_amt) }}"
                                    oninput="calExpenseTotal()">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('towel_qty', $homeCarMain->towel_qty) }}"
                                    oninput="calExpenseAmt('towel', this.value)">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('towel_amt', $homeCarMain->towel_amt) }}" oninput="calExpenseTotal()">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('plastic_bag_qty', $homeCarMain->plastic_bag_qty) }}"
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('plastic_bag_amt', $homeCarMain->plastic_bag_amt) }}"
                                    oninput="calExpenseTotal()">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('candy_qty', $homeCarMain->candy_qty) }}"
                                    oninput="calExpenseAmt('candy', this.value)">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('candy_amt', $homeCarMain->candy_amt) }}" oninput="calExpenseTotal()">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('guest_reg', $homeCarMain->guest_reg) }}" oninput="calExpenseTotal()">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('medicine', $homeCarMain->medicine) }}" oninput="calExpenseTotal()">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('coffee', $homeCarMain->coffee) }}" oninput="calExpenseTotal()">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('coffee_cup', $homeCarMain->coffee_cup) }}"
                                    oninput="calExpenseTotal()">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    ...
                                    value="{{ old('ticket_disc', $homeCarMain->ticket_disc) }}"
                                    oninput="calExpenseTotal()">
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex justify-end gap-5">
                    <div class="mb-2">
                        ...
                        <input readonly
                            ...
                            value="{{ old('total_expense', $homeCarMain->total_expense) }}">
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-5">
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('pot_sat', $homeCarMain->pot_sat) }}" oninput="calRtaExpenseTotal()">
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('la_tha', $homeCarMain->la_tha) }}" oninput="calRtaExpenseTotal()">
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('copy', $homeCarMain->copy) }}" oninput="calRtaExpenseTotal()">
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input readonly
                            ...
                            value="{{ old('total_rta', $homeCarMain->total_rta) }}">
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-5">
                    <div class="mb-2">
                        ...
                        <input readonly
                            ...
                            value="{{ old('credit_cargo_readonly', $homeCarMain->credit_cargo) }}">
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input readonly
                            ...
                            value="{{ old('ygn_lan_tg_ticket', $homeCarMain->ygn_lan_tg_ticket) }}">
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input readonly
                            ...
                            value="{{ old('lan_tg_ticket', $homeCarMain->lan_tg_ticket) }}">
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('gate_out', $homeCarMain->gate_out) }}" oninput="calTotal()">
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-5">
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('ferry', $homeCarMain->ferry) }}" oninput="calTotal()">
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('ask_khauk_to', $homeCarMain->ask_khauk_to) }}" oninput="calTotal()">
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('deli', $homeCarMain->deli) }}" oninput="calTotal()">
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('khauk_to', $homeCarMain->khauk_to) }}" oninput="calTotal()">
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('other_expense', $homeCarMain->other_expense) }}" oninput="calTotal()">
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('site_shin', $homeCarMain->site_shin) }}" oninput="calTotal()">
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-5">
                    <div class="mb-2">
                        ...
                        <input readonly
                            ...
                            value="{{ old('total', $homeCarMain->total) }}">
                    </div>
                </div>

                <div class="flex gap-5 item-center">
                    <button
                        class="px-4 py-3 text-base font-bold text-white bg-blue-500 rounded-lg hover:bg-blue-700 focus:outline-none focus:shadow-outline"
                        type="submit">
                        Update
                    </button>
                    @php
                        $route = $homeCarMain->cb
                            ? route('home-car-main-cbs.edit', $homeCarMain->cb->id)
                            : route('home-car-main-cbs.create', $homeCarMain->id);
                    @endphp
                    <a href="{{ $route . '?from=main' }}" type="button"
                        class="px-4 py-3 text-base font-bold text-white bg-blue-500 rounded-lg hover:bg-blue-700 focus:outline-none focus:shadow-outline">
                        Cashbook</a>
                </div>
...
@section('scripts')
    <script>
        ...
        let selectedDailyCar = dailyCars.find(car => car.id == {{ $homeCarMain->daily_car_list_id }});
        let routeType = selectedDailyCar.tour.route_type;
        let selectedSetting = settings.find(setting => setting.tour_id == selectedDailyCar.tour_id);
        let gatePercentsByTour = gatePercents.filter(gatePercent => gatePercent.tour_id ==
            selectedDailyCar.tour_id);
        let selectedGatePercent = gatePercentsByTour.find(gatePercent => {{ $homeCarMain->grand_total }} >= gatePercent
            .start_amount && {{ $homeCarMain->grand_total }} <= gatePercent.end_amount);
