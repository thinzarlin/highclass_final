...
@section('content')
    <div class="pb-5 text-xl text-gray-700">
        ...
        <div class="flex justify-start mt-1">
            <a href="{{ route('sample-home-car-cbs.index') }}" type="button"
        ...
        <div class="w-full">
            <form method="POST" action="{{ route('sample-home-car-cbs.update', $sampleHomeCarCb->id) }}"
                    ...
                    <div class="mb-2">
                        ...
                        <select
                            ...
                            @foreach ($tours as $key => $tour)
                                <option value="{{ $tour->id }}" {{ old('tour_id', $sampleHomeCarCb->tour_id) == $tour->id ? 'selected' : '' }}>
                                    {{ $tour->short_name }}
                                </option>
                            @endforeach
                    ...
                    <div class="grid grid-cols-9 gap-4">
                        <div class="hidden mb-2">
                            ...
                            <input
                                ...
                                value="{{ old('max_line_no', count($sampleHomeCarCb->details) + 1) }}">
                        </div>
                    ...
                    <div class="mb-4">
                        <div class="relative overflow-x-auto">
                            <table
                                ...
                                <tbody>
                                    @if ($sampleHomeCarCb->details)
                                        @foreach ($sampleHomeCarCb->details as $detail)
                ...
                <div class="flex justify-end gap-5">
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('net_amount_debit_label', number_format($sampleHomeCarCb->net_amount_debit)) }}" readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('net_amount_credit_label', number_format($sampleHomeCarCb->net_amount_credit)) }}" readonly>
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-5">
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('total_1_label', number_format($sampleHomeCarCb->total)) }}" readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('total_2_label', number_format($sampleHomeCarCb->total)) }}" readonly>
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-5">
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('total_income_label', number_format($sampleHomeCarCb->total_income)) }}" readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('total_expense_label', number_format($sampleHomeCarCb->total_expense)) }}" readonly>
                    </div>
                </div>
                ...
                <div class="justify-end gap-5 hidden">
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('net_amount_debit', $sampleHomeCarCb->net_amount_debit) }}" readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('net_amount_credit', $sampleHomeCarCb->net_amount_credit) }}" readonly>
                    </div>
                </div>
                ...
                <div class="justify-end gap-5 hidden">
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('total_1', $sampleHomeCarCb->total) }}" readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('total_2', $sampleHomeCarCb->total) }}" readonly>
                    </div>
                </div>
                ...
                <div class="justify-end gap-5 hidden">
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('total_income', $sampleHomeCarCb->total_income) }}" readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('total_expense', $sampleHomeCarCb->total_expense) }}" readonly>
                    </div>
                </div>
