...
@section('content')
    <div class="pb-5 text-xl text-gray-700">
        ...
        <div class="w-full">
            <form method="POST" action="{{ route('sample-home-car-cbs.store') }}" enctype="multipart/form-data"
                ...
                <section id="detailSection">
                    <div class="grid grid-cols-9 gap-4">
                        ...
                        <div class="col-span-2 mb-2">
                            ...
                            <select
                                class="select2 w-249 shadow py-1 px-2.5 leading-[2] bg-white border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                                id="coa_id">
                                ...
                                <tbody>
                                    <tr class="bg-slate-50 text-gray-800 text-sm border-b border-gray-200">
                                        ...
                                        <td class="px-3 py-2 text-right border">
                                            <input type="hidden" value="{{ 1 }}" name='line_no[]'>
                                            1
                                        </td>
                                        ...
                                        <td class="px-3 py-2 border">
                                            <input type="hidden" value="{{ 2 }}" name='coa_id[]'>
                                            <input type="hidden" value="{{ 'လမ်းကြေး' }}"
                                                name='coa_name[]'>
                                            လမ်းကြေး
                                        </td>
                                        <td class="px-3 py-2 border">
                                        ...
                                        <td class="px-3 py-2 text-right border">
                                            <input type="hidden" value="{{ 0 }}" name='debit[]'>0
                                        </td>
                                        <td class="px-3 py-2 text-right border">
                ...
                <div class="flex justify-end gap-5">
                    <div class="mb-2">
                        <input
                            ...
                            placeholder="Net Amount" value="{{ old('net_amount_debit_label', 0) }}" readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        <input
                            ...
                            placeholder="Net Amount" value="{{ old('net_amount_credit_label', 0) }}" readonly>
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-5">
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('total_1_label', 0) }}" readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('total_2_label', 0) }}" readonly>
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-5">
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('total_income_label', 0) }}" readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        <input
                            ...
                            placeholder="Credit Total" value="{{ old('total_expense_label', 0) }}" readonly>
                    </div>
                </div>
                ...
                <div class="justify-end gap-5 hidden">
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('net_amount_debit', 0) }}" readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('net_amount_credit', 0) }}" readonly>
                    </div>
                </div>
                ...
                <div class="justify-end gap-5 hidden">
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('total_income', 0) }}" readonly>
                    </div>
                    ...
                    <div class="mb-2">
                        <input
                            ...
                            value="{{ old('total_expense', 0) }}" readonly>
                    </div>
                </div>
