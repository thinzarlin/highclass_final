...
@section('content')
    <div class="pb-5 text-xl text-gray-700">
        ...
        <div class="w-full">
            <form method="POST" action="{{ route('diesels.update', $diesel->id) }}" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-6 gap-4">
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('ref_no', $diesel->ref_no) }}" readonly required>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('out_date', $diesel->out_date) }}" required>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('in_date', $diesel->in_date) }}" required>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            autocomplete="off" value="{{ old('purchase_date', $diesel->purchase_date) }}" required>
                        ...
                        <select
                            ...
                            @foreach ($daily_cars as $key => $daily_car)
                                <option value="{{ $daily_car->id }}"
                                    {{ old('daily_car_list_id', $diesel->daily_car_list_id) == $daily_car->id ? 'selected' : '' }}>
                        ...
                        <select
                            ...
                            @foreach ($tours as $key => $tour)
                                <option value="{{ $tour->id }}"
                                    {{ old('tour_id', $diesel->tour_id) == $tour->id ? 'selected' : '' }}>
                                    {{ $tour->short_name }}
                                </option>
                            @endforeach
                    ...
                    <div class="mb-2">
                        ...
                        <select
                            ...
                            @foreach ($cars as $key => $car)
                                <option value="{{ $car->id }}"
                                    {{ old('car_id', $diesel->car_id) == $car->id ? 'selected' : '' }}>
                                    {{ $car->car_no }}
                                </option>
                            @endforeach
                    ...
                    <div class="mb-2">
                        ...
                        <select
                            ...
                            @foreach (config('enums.route_types') as $key => $value)
                                <option value="{{ $key }}"
                                    {{ old('route_type', $diesel->route_type) == $key ? 'selected' : '' }}>
                                    {{ $value }}
                                </option>
                            @endforeach
                    ...
                    <div class="mb-2">
                        ...
                        <select
                            ...
                            @foreach (config('enums.payment_types') as $key => $value)
                                <option value="{{ $key }}"
                                    {{ old('payment_type', $diesel->payment_type) == $key ? 'selected' : '' }}>
                                    {{ $value }}
                                </option>
                            @endforeach
                ...
                <div class="grid grid-cols-6 gap-4">
                        ...
                        <select
                            ...
                            @foreach ($shops as $key => $shop)
                                <option value="{{ $shop->id }}"
                                    {{ old('shop_id', $diesel->shop_id) == $shop->id ? 'selected' : '' }}>
                                    {{ $shop->name }}
                                </option>
                            @endforeach
                    ...
                    <div class="col-span-2 mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('remark', $diesel->remark) }}">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-8 gap-4">
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('liter', $diesel->liter) }}" oninput="calGallon()" required>
                        @error('liter')
                            <div class="p-1 text-base text-red-600">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('gallon', $diesel->gallon) }}" oninput="calLiter()" required>
                        @error('gallon')
                            <div class="p-1 text-base text-red-600">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('price', $diesel->price) }}" oninput="calAmount()" required>
                        @error('price')
                            <div class="p-1 text-base text-red-600">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('discount', $diesel->discount) }}" oninput="calAmount()">
                        @error('discount')
                            <div class="p-1 text-base text-red-600">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('amount', $diesel->amount) }}" readonly required>
                        @error('amount')
                            <div class="p-1 text-base text-red-600">
                                {{ $message }}
                            </div>
