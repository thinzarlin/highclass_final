...
@section('content')
    <div class="pb-5 text-xl text-gray-700">
        ...
        <div class="w-full">
            <form method="POST" action="{{ route('daily-car-lists.store') }}" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-6 gap-4">
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('sr_no', $sr_no) }}" readonly required>
                    ...
                    <div class="mb-2">
                        ...
                        <select
                            ...
                            @foreach ($spares as $key => $spare)
                                <option value="{{ $spare->id }}" {{ old('spare_id') == $spare->id ? 'selected' : '' }}>
                                    {{ $spare->name }}
                                </option>
                            @endforeach
