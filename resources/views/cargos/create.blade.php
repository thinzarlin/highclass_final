                ...
                <div class="grid grid-cols-6 gap-4">
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('date', $today->format('d-m-Y')) }}" required>
                ...
                <div class="grid grid-cols-4 gap-4">
                    ...
                    <div class="mb-2">
                        ...
                        <select
                            ...
                            @foreach ($ygn_gates as $key => $gate)
                                <option value="{{ $gate->id }}"
                                    {{ old('from_gate_id') == $gate->id ? 'selected' : '' }}>
                                    {{ $gate->mm_name }}
                                </option>
                            @endforeach
                ...
                <div class="grid grid-cols-9 gap-4">
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('cargo_amt', 0) }}" oninput="calTotal()" required>
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('khauk_to', 0) }}" oninput="calTotal()" required>
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('deli', 0) }}" oninput="calTotal()" required>
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('bawdar_fee', 0) }}" oninput="calTotal()" required>
                    </div>
                    ...
                    <div class="mb-2">
                        ...
                        <input
                            ...
                            value="{{ old('site_shin', 0) }}" oninput="calTotal()" required>
                    </div>
